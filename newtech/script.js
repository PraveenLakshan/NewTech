...
function addProduct() {
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            var t = r.responseText;
            if (t == "Product Image Saved Succesfully") {
                window.location.reload();
            } else {
                alert(t);
            }
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "1") {
                ...
                var payment = {
                    "sandbox": true,
                    "merchant_id": "1221215",    // Replace your Merchant ID
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == 1) {
                ...
                document.getElementById("btn" + id).classList = "btn btn-warning mt-1 mb-1";



            } else if (t == 2) {
                document.getElementById("btn" + id).innerHTML = "Dispatch";
                document.getElementById("btn" + id).classList = "btn btn-info mt-1 mb-1";


            } if (t == 3) {
                document.getElementById("btn" + id).innerHTML = "Shipping";
                document.getElementById("btn" + id).classList = "btn btn-primary mt-1 mb-1";


            } if (t == 4) {
                document.getElementById("btn" + id).innerHTML = "Delivered";
                document.getElementById("btn" + id).classList = "btn btn-danger mt-1 mb-1";
