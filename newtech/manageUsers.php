...
<head>
    ...
    <title>Manage Users | Admin |  New Tech</title>
        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-2 d-none d-lg-block bg-light py-2">
                        <span class="fs-4 fw-bold ">Registration Date</span>
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body overflow-scroll">
                                ...
                                $msg_rs1 = Database::search("SELECT DISTINCT `content`,`date_time`,`status` FROM `chat` WHERE `to` = 
                               '" . $_SESSION["u"]["email"] . "' AND `form` = '" . $selected_data["email"] . "'");

                                $msg_rs2 = Database::search("SELECT DISTINCT `content`,`date_time`,`status` FROM `chat` WHERE `form` = 
                                '" . $_SESSION["u"]["email"] . "' AND `to` = '" . $selected_data["email"] . "'");
                                            ...
                                            <div class="col-8 rounded bg-success">
                                                <div class="row">
                                                    <div class="col-12 pt-2">
                                                        <span class="text-white fs-4"><?php echo $msg_data1["content"] ?></span>
                                                    </div>
                                                    <div class="co col-12 text-end pb-2">
                                                        <span class="text-white fs-6"><?php echo $msg_data1["date_time"] ?><span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        <div class="row">
                                            <div class="offset-4 col-8 rounded bg-primary">
                                                <div class="row">
                                                    <div class="col-12 pt-2">
                                                        <span class="text-white fs-4"><?php echo $msg_data2["content"] ?></span>
                                                    </div>
                                                    <div class="co col-12 text-end pb-2">
                                                        <span class="text-white fs-6"><?php echo $msg_data2["date_time"] ?><span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-3 d-grid">
                                            ...
                                            <!-- //overload different parameeters -->
                                        </div>
                                    </div>
                                </div>
