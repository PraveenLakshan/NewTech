                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="resource/slider_images/poster04.jpg" class="d-block w-100" />
                                    </div>
                                    <div class="carousel-item">
                                        <img src="resource/slider_images/poster05.jpg" class="d-block w-100" />
                                    </div>
                                    <div class="carousel-item">
                                        <img src="resource/slider_images/poster03.jpg" class="d-block w-100" />
                                    </div>
                                </div>
                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        `status_id`='1' ORDER BY `datetime_added` DESC LIMIT 8 OFFSET 0");
                                        ...
                                        ?>
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    if ($product_data["qtyl"] > 0) {

                                                    ?>

                                                        <span class="card-text text-warning fw-bold">In Stock</span> <br />
                                                        <span class="card-text text-success fw-bold"><?php echo $product_data["qtyl"]; ?> Items Available</span><br /><br />
