            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-11 bg-dark active-time-bar">
                            <div class="row">
                                <div class="col-12 col-lg-2 text-center">
                                    <label class="form-label fs-4 fw-bold text-white">Total Active Time</label>
                                </div>
                                <div class="col-12 col-lg-10 text-center mt-3">
                            ...
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $image_data["code"]; ?>" class="img-fluid rounded-top" style="height: 220px;" />
                                    </div>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="resource/empty.svg" class="img-fluid rounded-top" style="height: 220px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold">_______________</span><br />
                                        <span class="fs-6">________ Items</span><br />
                                        <span class="fs-6">Rs._______.00</span>
                                    </div>
                        ...
                        <div class="offset-2 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1">
                                <div class="col-12 text-center">
                                ...
                                ?>
                                  <div class="col-12 text-center shadow">
                                        <img src="<?php echo $profile_data["path"]; ?>" class="img-fluid rounded-top" style="height: 220px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="resource/new_user.svg" class="img-fluid rounded-top" style="height: 220px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold">________ ________</span><br />
                                        <span class="fs-6">_________________________</span><br />
                                        <span class="fs-6">__________</span>
                                    </div>
                                <?php
