...
<head>
    ...
    <title>Selling History | Admin | New Tech</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-light text-center">
                <label class="form-label text-primary fs-1 fw-bold">Selling History</label>
            </div>
            <div class="col-12 mt-3 mb-3 bg-light">
                <div class="row">
                    <div class="col-12 mt-3 mb-3 col-lg-3">
                    ...
                    <div class="col-12 mt-3 mb-3 col-lg-2"></div>
                    <div class="col-12 mt-3 mb-3 col-lg-3">
                    ...
                    <div class="col-12 mt-3 mb-3 col-lg-1 d-grid">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-1 bg-secondary text-end">
                        <label class="form-label fs-5 fw-bold text-white">Invoide Id</label>
                    </div>
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 bg-white d-grid">
                            ...
                            ?>
                                <button class="btn btn-success mt-1 mb-1" onclick="changeStatus('<?php echo $selected_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Confirm Order</button>
                            <?php
                            } else if ($selected_data["status"] == 1) {
                            ?>
                                <button class="btn btn-warning mt-1 mb-1" onclick="changeStatus('<?php echo $selected_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Packing</button>
                            <?php
                            } else if ($selected_data["status"] == 2) {
                            ?>
                                <button class="btn btn-info mt-1 mb-1" onclick="changeStatus('<?php echo $selected_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Dispatch</button>
                            <?php
                            } else if ($selected_data["status"] == 3) {
                            ?>
                                <button class="btn btn-primary mt-1 mb-1" onclick="changeStatus('<?php echo $selected_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Shipping</button>
                            <?php
                            } else if ($selected_data["status"] == 4) {
                            ?>
                                <button class="btn btn-danger mt-1 mb-1 disabled" onclick="changeStatus('<?php echo $selected_data['id']; ?>');" id="btn<?php echo $selected_data["id"]; ?>">Delivered</button>
                            <?php
                            }
                            ?>
