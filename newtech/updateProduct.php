                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" placeholder="Add A New Color" disabled />
                                            ...
                                            <div class="col-12 col-lg-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="number" class="form-control" value="<?php echo $product["qtyl"]; ?>" min="0" id="q"/>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <textarea class="form-control" id="d" cols="30" rows="15"><?php echo $product["description"]; ?></textarea>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="offset-lg-3 col-12 col-lg-6">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-4 border border-primary rounded">
                                                                                <img src="<?php echo $img[2]; ?>" class="img-fluid" style="width: 250px;" id="2"/>
