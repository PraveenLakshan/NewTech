...
<body style="background-color: #000046;">
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="offset-lg-4 col-12 col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-10 text-center">
                                <p class="fs-1 text-black-50 fw-bold m-3 p-2">Advanced Search</p>
            ...
            <div class="offset-lg-0 col-12 col-lg-12 bg-body rounded mb-2">
                <div class="row">
                ...
                <div class="row">
                    <div class="offset-lg-8 offset-4 col-8 col-lg-4 mt-2 mb-2">
                        <select class="form-select border border-start-0 border-top-0 border-end-0 border-2 border-primary shadow-none" id="s">
                            ...
                            <option value="4">Quatintity Low To High</option>
                        </select>
