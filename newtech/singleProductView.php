...
if (isset($_GET["id"])) {
    ...
    $product_rs = Database::search("SELECT product.price,product.qtyl,product.description,product.title,
                                                ...
                                                <div class="row border-bottom border-dark">
                                                    <div class="col-12 my-2">
                                                        <span class="badge">
                                                            ...
                                                            <label class="fs-5 text-dark fw-bold">4.5 Stars | 50 Reviews & Ratings</label>
                                                        </span>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12 my-2">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                <span class="fs-5 text-primary">Praveen Lakshan</span>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                    ...
                                    <div class="col-12 mt-1 mb-1 mx-1">
                                        <div class="row border border-1 border-dark rounded me-0">
                                            <div class="col-10 mt-1 mb-1 ms-0">
                                                <span class="fw-bold">Praveen</span>
                                            </div>
